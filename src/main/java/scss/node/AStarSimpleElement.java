...
public final class AStarSimpleElement extends PSimpleElement
{
    private TStar _star_;

    public AStarSimpleElement()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAStarSimpleElement(this);
    }
