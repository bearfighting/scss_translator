...
public final class AVariableNameExpression extends PExpression
{
    private TVariable _variable_;

    public AVariableNameExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariableNameExpression(
    ...
    {
        ((Analysis) sw).caseAVariableNameExpression(this);
    }
