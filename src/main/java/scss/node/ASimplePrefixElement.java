...
public final class ASimplePrefixElement extends PPrefixElement
{
    private PElement _element_;

    public ASimplePrefixElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimplePrefixElement(
    ...
    {
        ((Analysis) sw).caseASimplePrefixElement(this);
    }
